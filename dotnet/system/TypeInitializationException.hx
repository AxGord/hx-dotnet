...
@:native('System.TypeInitializationException') extern class TypeInitializationException {
	function new(fullTypeName:String, innerException:dotnet.system.Exception):Void;
