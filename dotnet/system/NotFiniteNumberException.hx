...
@:native('System.NotFiniteNumberException') extern class NotFiniteNumberException {
	...
	@:overload(function(message:String, offendingNumber:Float, innerException:dotnet.system.Exception):Void{})
	function new():Void;
	...
	var OffendingNumber(default,null):Float;
