...
@:native('System.Text.ASCIIEncoding') extern class ASCIIEncoding {
	function new():Void;
	...
	function GetBytes(chars:String, charIndex:Int, charCount:Int, bytes:cs.NativeArray<dotnet.system.Byte>, byteIndex:Int):Int;
	...
	function GetString(bytes:cs.NativeArray<dotnet.system.Byte>, byteIndex:Int, byteCount:Int):String;
