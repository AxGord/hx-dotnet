...
@:native('System.Text.DecoderFallbackException') extern class DecoderFallbackException {
	@:overload(function(message:String):Void{})
	@:overload(function(message:String, innerException:dotnet.system.Exception):Void{})
	@:overload(function(message:String, bytesUnknown:dotnet.system.Byte, index:Int):Void{})
	function new():Void;
	var BytesUnknown(default,null):dotnet.system.Byte;
