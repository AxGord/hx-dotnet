...
@:native('System.Globalization.GregorianCalendar') extern class GregorianCalendar {
	@:overload(function(type:dotnet.system.globalization.GregorianCalendarTypes):Void{})
	function new():Void;
	var AlgorithmType(default,null):dotnet.system.globalization.CalendarAlgorithmType;
	var CalendarType(default,default):dotnet.system.globalization.GregorianCalendarTypes;
