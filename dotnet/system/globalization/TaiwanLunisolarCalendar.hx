...
@:native('System.Globalization.TaiwanLunisolarCalendar') extern class TaiwanLunisolarCalendar {
	function new():Void;
	...
	function GetDaysInYear(year:Int):Int;
	...
	function GetSexagenaryYear(time:dotnet.system.DateTime):Int;
