...
@:native('System.IO.Log.IRecordSequence') extern class IRecordSequence {
	...
	function BeginAppend(data:dotnet.system.collections.generic.IList, nextUndoRecord:dotnet.system.iO.log.SequenceNumber, previousUndoRecord:dotnet.system.iO.log.SequenceNumber, recordAppendOptions:dotnet.system.iO.log.RecordAppendOptions, reservations:dotnet.system.iO.log.ReservationCollection, _callback:dotnet.system.AsyncCallback, state:Dynamic):dotnet.system.IAsyncResult;
	...
	@:overload(function(data:dotnet.system.ArraySegment, newBaseSequenceNumber:dotnet.system.iO.log.SequenceNumber, reservation:dotnet.system.iO.log.ReservationCollection, _callback:dotnet.system.AsyncCallback, state:Dynamic):dotnet.system.IAsyncResult{})
	function BeginWriteRestartArea(data:dotnet.system.collections.generic.IList, newBaseSequenceNumber:dotnet.system.iO.log.SequenceNumber, reservation:dotnet.system.iO.log.ReservationCollection, _callback:dotnet.system.AsyncCallback, state:Dynamic):dotnet.system.IAsyncResult;
	...
	@:overload(function(data:dotnet.system.ArraySegment, newBaseSequenceNumber:dotnet.system.iO.log.SequenceNumber):dotnet.system.iO.log.SequenceNumber{})
	@:overload(function(data:dotnet.system.collections.generic.IList, newBaseSequenceNumber:dotnet.system.iO.log.SequenceNumber):dotnet.system.iO.log.SequenceNumber{})
	@:overload(function(data:dotnet.system.ArraySegment, newBaseSequenceNumber:dotnet.system.iO.log.SequenceNumber, reservation:dotnet.system.iO.log.ReservationCollection):dotnet.system.iO.log.SequenceNumber{})
	function WriteRestartArea(data:dotnet.system.collections.generic.IList, newBaseSequenceNumber:dotnet.system.iO.log.SequenceNumber, reservation:dotnet.system.iO.log.ReservationCollection):dotnet.system.iO.log.SequenceNumber;
}