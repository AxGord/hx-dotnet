...
@:native('System.IO.Pipes.NamedPipeClientStream') extern class NamedPipeClientStream {
	@:overload(function(serverName:String, pipeName:String):Void{})
	@:overload(function(serverName:String, pipeName:String, direction:dotnet.system.iO.pipes.PipeDirection):Void{})
	...
	@:overload(function(serverName:String, pipeName:String, direction:dotnet.system.iO.pipes.PipeDirection, options:dotnet.system.iO.pipes.PipeOptions):Void{})
	@:overload(function(serverName:String, pipeName:String, direction:dotnet.system.iO.pipes.PipeDirection, options:dotnet.system.iO.pipes.PipeOptions, impersonationLevel:dotnet.system.security.principal.TokenImpersonationLevel):Void{})
	@:overload(function(serverName:String, pipeName:String, desiredAccessRights:dotnet.system.iO.pipes.PipeAccessRights, options:dotnet.system.iO.pipes.PipeOptions, impersonationLevel:dotnet.system.security.principal.TokenImpersonationLevel, inheritability:dotnet.system.iO.HandleInheritability):Void{})
	@:overload(function(serverName:String, pipeName:String, direction:dotnet.system.iO.pipes.PipeDirection, options:dotnet.system.iO.pipes.PipeOptions, impersonationLevel:dotnet.system.security.principal.TokenImpersonationLevel, inheritability:dotnet.system.iO.HandleInheritability):Void{})
	...
	var NumberOfServerInstances(default,null):Int;
