...
@:native('System.IO.Pipes.AnonymousPipeClientStream') extern class AnonymousPipeClientStream {
	@:overload(function(direction:dotnet.system.iO.pipes.PipeDirection, safePipeHandle:dotnet.microsoft.win32.safeHandles.SafePipeHandle):Void{})
	@:overload(function(direction:dotnet.system.iO.pipes.PipeDirection, pipeHandleAsString:String):Void{})
	function new(pipeHandleAsString:String):Void;
