...
@:native('System.IO.Pipes.NamedPipeServerStream') extern class NamedPipeServerStream {
	@:overload(function(pipeName:String, direction:dotnet.system.iO.pipes.PipeDirection):Void{})
	@:overload(function(pipeName:String, direction:dotnet.system.iO.pipes.PipeDirection, maxNumberOfServerInstances:Int):Void{})
	@:overload(function(direction:dotnet.system.iO.pipes.PipeDirection, isAsync:Bool, isConnected:Bool, safePipeHandle:dotnet.microsoft.win32.safeHandles.SafePipeHandle):Void{})
	@:overload(function(pipeName:String, direction:dotnet.system.iO.pipes.PipeDirection, maxNumberOfServerInstances:Int, transmissionMode:dotnet.system.iO.pipes.PipeTransmissionMode):Void{})
	@:overload(function(pipeName:String, direction:dotnet.system.iO.pipes.PipeDirection, maxNumberOfServerInstances:Int, transmissionMode:dotnet.system.iO.pipes.PipeTransmissionMode, options:dotnet.system.iO.pipes.PipeOptions):Void{})
	@:overload(function(pipeName:String, direction:dotnet.system.iO.pipes.PipeDirection, maxNumberOfServerInstances:Int, transmissionMode:dotnet.system.iO.pipes.PipeTransmissionMode, options:dotnet.system.iO.pipes.PipeOptions, inBufferSize:Int, outBufferSize:Int):Void{})
	@:overload(function(pipeName:String, direction:dotnet.system.iO.pipes.PipeDirection, maxNumberOfServerInstances:Int, transmissionMode:dotnet.system.iO.pipes.PipeTransmissionMode, options:dotnet.system.iO.pipes.PipeOptions, inBufferSize:Int, outBufferSize:Int, pipeSecurity:dotnet.system.iO.pipes.PipeSecurity):Void{})
	@:overload(function(pipeName:String, direction:dotnet.system.iO.pipes.PipeDirection, maxNumberOfServerInstances:Int, transmissionMode:dotnet.system.iO.pipes.PipeTransmissionMode, options:dotnet.system.iO.pipes.PipeOptions, inBufferSize:Int, outBufferSize:Int, pipeSecurity:dotnet.system.iO.pipes.PipeSecurity, inheritability:dotnet.system.iO.HandleInheritability):Void{})
	@:overload(function(pipeName:String, direction:dotnet.system.iO.pipes.PipeDirection, maxNumberOfServerInstances:Int, transmissionMode:dotnet.system.iO.pipes.PipeTransmissionMode, options:dotnet.system.iO.pipes.PipeOptions, inBufferSize:Int, outBufferSize:Int, pipeSecurity:dotnet.system.iO.pipes.PipeSecurity, inheritability:dotnet.system.iO.HandleInheritability, additionalAccessRights:dotnet.system.iO.pipes.PipeAccessRights):Void{})
	function new(pipeName:String):Void;
	...
	var ReadMode(default,default):dotnet.system.iO.pipes.PipeTransmissionMode;
	...
	function BeginWaitForConnection(_callback:dotnet.system.AsyncCallback, state:Dynamic):dotnet.system.IAsyncResult;
	...
	function EndWaitForConnection(asyncResult:dotnet.system.IAsyncResult):Void;
	...
	function RunAsClient(impersonationWorker:dotnet.system.iO.pipes.PipeStreamImpersonationWorker):Void;
	...
	var MaxAllowedServerInstances:Int;
}