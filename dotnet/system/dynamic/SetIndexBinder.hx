...
@:native('System.Dynamic.SetIndexBinder') extern class SetIndexBinder {
	...
	@:overload(function(target:dotnet.system.dynamic.DynamicMetaObject, indexes:cs.NativeArray<dotnet.system.dynamic.DynamicMetaObject>, value:dotnet.system.dynamic.DynamicMetaObject):dotnet.system.dynamic.DynamicMetaObject{})
	function FallbackSetIndex(target:dotnet.system.dynamic.DynamicMetaObject, indexes:cs.NativeArray<dotnet.system.dynamic.DynamicMetaObject>, value:dotnet.system.dynamic.DynamicMetaObject, errorSuggestion:dotnet.system.dynamic.DynamicMetaObject):dotnet.system.dynamic.DynamicMetaObject;
