...
@:native('System.Dynamic.DeleteMemberBinder') extern class DeleteMemberBinder {
	...
	function FallbackDeleteMember(target:dotnet.system.dynamic.DynamicMetaObject, errorSuggestion:dotnet.system.dynamic.DynamicMetaObject):dotnet.system.dynamic.DynamicMetaObject;
