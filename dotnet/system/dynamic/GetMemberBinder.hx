...
@:native('System.Dynamic.GetMemberBinder') extern class GetMemberBinder {
	...
	function FallbackGetMember(target:dotnet.system.dynamic.DynamicMetaObject, errorSuggestion:dotnet.system.dynamic.DynamicMetaObject):dotnet.system.dynamic.DynamicMetaObject;
