...
@:native('System.Dynamic.DeleteIndexBinder') extern class DeleteIndexBinder {
	...
	function FallbackDeleteIndex(target:dotnet.system.dynamic.DynamicMetaObject, indexes:cs.NativeArray<dotnet.system.dynamic.DynamicMetaObject>, errorSuggestion:dotnet.system.dynamic.DynamicMetaObject):dotnet.system.dynamic.DynamicMetaObject;
