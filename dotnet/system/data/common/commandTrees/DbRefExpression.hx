...
@:native('System.Data.Common.CommandTrees.DbRefExpression') extern class DbRefExpression {
	var Argument(default,null):dotnet.system.data.common.commandTrees.DbExpression;
	var EntitySet(default,null):dotnet.system.data.metadata.edm.EntitySet;
