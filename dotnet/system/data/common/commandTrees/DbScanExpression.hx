...
@:native('System.Data.Common.CommandTrees.DbScanExpression') extern class DbScanExpression {
	...
	var Target(default,null):dotnet.system.data.metadata.edm.EntitySetBase;
