...
@:native('System.Data.Common.CommandTrees.DbParameterReferenceExpression') extern class DbParameterReferenceExpression {
	var ExpressionKind(default,null):dotnet.system.data.common.commandTrees.DbExpressionKind;
	var ParameterName(default,null):String;
