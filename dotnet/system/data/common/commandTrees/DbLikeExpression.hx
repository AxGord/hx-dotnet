...
@:native('System.Data.Common.CommandTrees.DbLikeExpression') extern class DbLikeExpression {
	var Argument(default,null):dotnet.system.data.common.commandTrees.DbExpression;
	var Escape(default,null):dotnet.system.data.common.commandTrees.DbExpression;
	var ExpressionKind(default,null):dotnet.system.data.common.commandTrees.DbExpressionKind;
	var Pattern(default,null):dotnet.system.data.common.commandTrees.DbExpression;
