...
@:native('System.Data.Common.CommandTrees.DbCaseExpression') extern class DbCaseExpression {
	var Else(default,null):dotnet.system.data.common.commandTrees.DbExpression;
	...
	var Then(default,null):dotnet.system.collections.generic.IList;
	var When(default,null):dotnet.system.collections.generic.IList;
