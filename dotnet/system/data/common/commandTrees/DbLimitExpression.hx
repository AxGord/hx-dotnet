...
@:native('System.Data.Common.CommandTrees.DbLimitExpression') extern class DbLimitExpression {
	...
	var Limit(default,null):dotnet.system.data.common.commandTrees.DbExpression;
	var ResultType(default,null):dotnet.system.data.metadata.edm.TypeUsage;
	var WithTies(default,null):Bool;
