...
@:native('System.Data.Common.CommandTrees.DbProjectExpression') extern class DbProjectExpression {
	...
	var Projection(default,null):dotnet.system.data.common.commandTrees.DbExpression;
