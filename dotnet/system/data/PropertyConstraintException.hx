...
@:native('System.Data.PropertyConstraintException') extern class PropertyConstraintException {
	@:overload(function(message:String):Void{})
	@:overload(function(message:String, innerException:dotnet.system.Exception):Void{})
	@:overload(function(message:String, propertyName:String):Void{})
	@:overload(function(message:String, propertyName:String, innerException:dotnet.system.Exception):Void{})
	function new():Void;
