...
@:native('System.Data.TypedDataSetGeneratorException') extern class TypedDataSetGeneratorException {
	@:overload(function(list:dotnet.system.collections.ArrayList):Void{})
	@:overload(function(message:String):Void{})
	@:overload(function(message:String, innerException:dotnet.system.Exception):Void{})
	function new():Void;
	var Data(default,null):dotnet.system.collections.IDictionary;
	var ErrorList(default,null):dotnet.system.collections.ArrayList;
