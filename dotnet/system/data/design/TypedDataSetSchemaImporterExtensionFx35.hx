...
@:native('System.Data.Design.TypedDataSetSchemaImporterExtensionFx35') extern class TypedDataSetSchemaImporterExtensionFx35 {
	function new():Void;
	...
	function ImportSchemaType(name:String, namespaceName:String, context:dotnet.system.xml.schema.XmlSchemaObject, schemas:dotnet.system.xml.serialization.XmlSchemas, importer:dotnet.system.xml.serialization.XmlSchemaImporter, compileUnit:dotnet.system.codeDom.CodeCompileUnit, mainNamespace:dotnet.system.codeDom.CodeNamespace, options:dotnet.system.xml.serialization.CodeGenerationOptions, codeProvider:dotnet.system.codeDom.compiler.CodeDomProvider):String;
