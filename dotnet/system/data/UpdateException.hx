...
@:native('System.Data.UpdateException') extern class UpdateException {
	@:overload(function(message:String):Void{})
	@:overload(function(message:String, innerException:dotnet.system.Exception):Void{})
	@:overload(function(message:String, innerException:dotnet.system.Exception, stateEntries:dotnet.system.collections.generic.IEnumerable):Void{})
	function new():Void;
	...
	var StateEntries(default,null):dotnet.system.collections.objectModel.ReadOnlyCollection;
