...
@:native('System.Data.DataTable') extern class DataTable {
	@:overload(function(tableName:String):Void{})
	@:overload(function(tableName:String, tableNamespace:String):Void{})
	function new():Void;
	...
	static function GetDataTableSchema(schemaSet:dotnet.system.xml.schema.XmlSchemaSet):dotnet.system.xml.schema.XmlSchemaComplexType;
