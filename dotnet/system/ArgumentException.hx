...
@:native('System.ArgumentException') extern class ArgumentException {
	@:overload(function(message:String):Void{})
	@:overload(function(message:String, innerException:dotnet.system.Exception):Void{})
	@:overload(function(message:String, paramName:String):Void{})
	@:overload(function(message:String, paramName:String, innerException:dotnet.system.Exception):Void{})
	function new():Void;
