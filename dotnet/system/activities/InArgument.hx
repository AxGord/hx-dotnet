...
@:native('System.Activities.InArgument') extern class InArgument<T> {
	@:overload(function(constValue:dotnet.<span class="typeparam" xmlns="http://www.w3.Org/1999/xhtml">T):Void{})
	...
	static function FromDelegateArgument(delegateArgument:dotnet.system.activities.DelegateArgument):dotnet.system.activities.InArgument;
	static function FromExpression(expression:dotnet.system.activities.Activity):dotnet.system.activities.InArgument;
	static function FromValue(constValue:dotnet.<span class="typeparam" xmlns="http://www.w3.Org/1999/xhtml">T):dotnet.system.activities.InArgument;
	static function FromVariable(variable:dotnet.system.activities.Variable):dotnet.system.activities.InArgument;
