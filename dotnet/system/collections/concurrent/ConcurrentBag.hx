...
@:native('System.Collections.Concurrent.ConcurrentBag') extern class ConcurrentBag<T> {
	...
	function TryTake(result:dotnet.<span class="typeparam" xmlns="http://www.w3.Org/1999/xhtml">T):Bool;
}