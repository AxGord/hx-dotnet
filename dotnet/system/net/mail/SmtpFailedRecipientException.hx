...
@:native('System.Net.Mail.SmtpFailedRecipientException') extern class SmtpFailedRecipientException {
	@:overload(function(message:String):Void{})
	@:overload(function(statusCode:dotnet.system.net.mail.SmtpStatusCode, failedRecipient:String):Void{})
	@:overload(function(message:String, innerException:dotnet.system.Exception):Void{})
	@:overload(function(statusCode:dotnet.system.net.mail.SmtpStatusCode, failedRecipient:String, serverResponse:String):Void{})
	...
	var FailedRecipient(default,null):String;
